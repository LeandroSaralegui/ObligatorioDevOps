...
El despliegue de microservicios utilizando Docker, Amazon ECS y Amazon ECR nos permitió comprender mejor los beneficios de la conteinerización, la independencia entre servicios y la facilidad para escalar aplicaciones.
...
Si bien no se implemento la estrategia correctamente debido a que no nombramos las ramas de manera correcta, el uso de estas herramientas fue de gran utilidad para el desarrollo del proyecto.
